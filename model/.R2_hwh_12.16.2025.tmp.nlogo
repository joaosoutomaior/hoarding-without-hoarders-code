...
;==================================================================
;             ANNONYMED VERSION FOR PEER REVIEW ONLY
...
to setup
  clear-all
  reset-ticks
  ; optional: to remove variation in the network formation model
  ifelse specific_seed = TRUE
  [
...
to create-agents
  ...
  create-turtles n_w [
    ...
    set race_i "White"
    set ses_i random-normal 0 ses_error_variance
  ...
  create-turtles n_b [
    ...
    set race_i "Black"
    set ses_i random-normal (-1 * bw_ses_diff) ses_error_variance
    set acad_i ses_i + random-normal 0 acad_error_variance
    set social_capital_i 0
...
@#$#@#$#@
<experiments>
  <experiment name="main" repetitions="2000" runMetricsEveryStep="false">
...
set folder_name "../data/main"</setup>
    ...
    <enumeratedValueSet variable="ses_error_variance">
      <value value="1"/>
    </enumeratedValueSet>
...
set folder_name "sens-homophily-consolidation"</setup>
  ...
  <experiment name="sens-ingroup-favoritism" repetitions="500" runMetricsEveryStep="false">
    <setup>random-seed behaviorspace-run-number
setup
set folder_name "../data/sens-ingroup-favoritism"</setup>
  ...
  <experiment name="sens-admin-pressures" repetitions="500" runMetricsEveryStep="false">
    <setup>random-seed behaviorspace-run-number
setup
set folder_name "../data/sens-admin-pressures"</setup>
  ...
  <experiment name="sens-racial-composition" repetitions="500" runMetricsEveryStep="false">
    <setup>random-seed behaviorspace-run-number
setup
set folder_name "../data/sens-racial-composition"</setup>
  ...
  <experiment name="sens-degree" repetitions="500" runMetricsEveryStep="false">
    <setup>random-seed behaviorspace-run-number
setup
...
setup</setup>
  ...
  <experiment name="sens-n-3000" repetitions="500" runMetricsEveryStep="false">
    <setup>random-seed behaviorspace-run-number
setup
set folder_name "../data/sens-n-3000"</setup>
    <go>go</go>
    <final>export-simdata</final>
    <enumeratedValueSet variable="model_type">
      <value value="&quot;Full model&quot;"/>
  ...
  <experiment name="sens-n-2000" repetitions="500" runMetricsEveryStep="false">
    <setup>random-seed behaviorspace-run-number
setup
set folder_name "../data/sens-n-2000"</setup>
    <go>go</go>
    <final>export-simdata</final>
    <enumeratedValueSet variable="model_type">
      <value value="&quot;Full model&quot;"/>
  ...
  <experiment name="sens-ses-error-variance" repetitions="2000" runMetricsEveryStep="false">
    <setup>random-seed behaviorspace-run-number
setup
set folder_name "../data/sens-ses-error-variance"</setup>
    <go>go</go>
    <final>export-simdata</final>
    <enumeratedValueSet variable="n">
      <value value="400"/>
    </enumeratedValueSet>
    <steppedValueSet variable="ses_error_variance" first="0.25" step="0.25" last="1"/>
    <enumeratedValueSet variable="acad_error_variance">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="model_type">
  ...
  <experiment name="sens-no-reversal" repetitions="1000" runMetricsEveryStep="false">
    <setup>random-seed behaviorspace-run-number
setup
set folder_name "../data/sens-no-reversal"</setup>
    <go>go</go>
    <final>export-simdata</final>
    <enumeratedValueSet variable="n">
      <value value="2000"/>
  ...
  <experiment name="sens_prob-adoption" repetitions="1000" runMetricsEveryStep="false">
    <setup>random-seed behaviorspace-run-number
setup
