...
#==============================================================
# contents: 
#  - main result: hoarding without hoarders
...
dat <- read_csv("../data/main/results.csv") %>%
...
# save
ggsave("figures/fig_main.png", width = 9, height = 10, units = "cm", dpi = 1000)
